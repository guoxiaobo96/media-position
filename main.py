from program.config import AnalysisArguments, get_config, DataArguments, MiscArgument, ModelArguments,TrainingArguments, DataAugArguments
...
if __name__ == '__main__':
    misc_args, model_args, data_args, aug_args, training_args, analysis_args = get_config()
