...
from program.run_function import train_adapter, predict_adapter,analysis, label_score_predict, label_score_analysis
...
def main(
    ...
    if misc_args.task == 'extract_data':
        ...
        label_score_predict(misc_args, model_args, data_args, training_args, adapter_args)
    elif misc_args.task == 'label_score_analysis':
        label_score_analysis(misc_args, model_args, data_args, training_args, analysis_args)
