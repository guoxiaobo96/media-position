...
label_method_list = ['declarative','declarative-choice','question','question-choice','association','association-choice','bigram_outer']
...
augmentation_method_list= ['no_augmentation']
